...
```json
{
    ...
    "frequency": {
        "number": 1,
        "unit": "month" // Possible values: "none", "day", "week", "month"
    },
    "description": "<optional_app_data>"
}
```
...
For budget requests, a frequency unit of "none" indicates a one-time budget without rollover.
